 ...
 * @return string
 */
function get_full_permalink($post) {
...
function optimizely_title_variations_render( $post ) {
	...
	<input type="hidden" id="optimizely_experiment_url" name="optimizely_experiment_url" value="<?php echo esc_url( get_full_permalink($post) ) ?>" />
